...
// PQ_Gavra is the priority queue
type PQ_Gavra struct {
...
func New(prioQueueLimit int) *PQ_Gavra {
...
func (pq *PQ_Gavra) Write(prio Priority, m interface{}) error {
...
func (pq *PQ_Gavra) Read() (interface{}, error) {
